...
class EasyWebtrends {
     ...
     * 
     * @uses add_action()
     * @uses EasyWebtrends::wp_register_scripts()
     * @uses EasyWebtrends::wp_register_styles()
     */
    function __construct() {
         ...
         */
        load_theme_textdomain( $this->namespace, EASYWEBTRENDS_DIRNAME . '/languages' );
    ...
    static function instance() {
        ...
        if( !isset( $EasyWebtrends ) ) $EasyWebtrends = new EasyWebtrends();
    }
     ...
     * form processor.
     * 
     * @uses EasyWebtrends::_admin_options_update()
     */
    function route() {
